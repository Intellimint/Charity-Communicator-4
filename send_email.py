...
brevo_api_key = "your_brevo_api_key_here"  # Replace this with your actual Brevo API key
openrouter_api_key = "your_openrouter_api_key_here"  # Replace this with your actual OpenRouter API key
